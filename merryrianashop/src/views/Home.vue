      ...
      <div class="contentChild">
        ...
        <div class="books">
          ...
          <div v-if="this.books.length > 0" class="forCards">
            <Card v-for="(data, idx) in this.books" :key="idx" :data="data"></Card>
          </div>
        </div>
          ...
          <div v-if="this.fashion.length > 0" class="forCards">
            <Card v-for="(fashion, idx) in this.fashion" :key="idx" :data="fashion"></Card>
          </div>
        </div>
        ...
        <div class="snack">
          ...
          <div v-if="this.snack.length > 0" class="forCards">
            <Card v-for="(snack, idx) in this.snack" :key="idx" :data="snack"></Card>
          </div>
        </div>
        ...
        <div class="allProducts">
          ...
          <hr>
          <div  class="forCards">
            <Card v-for="(allProducts, idx) in this.$store.state.allProducts" :key="idx" :data="allProducts"></Card>
          </div>
        </div>
